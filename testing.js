...
window.addEventListener("load", function() {
  console.log('termageddon 2');
    ...
    xhr.onerror = function () {
        ...
        var userRequest = new Request("https://embed.termageddon.com/api/render/TWtkWVptUlJNMnhyU20xUlMwRTlQUT09?origin="+window.location.href, initObject);
        ...
        fetch(userRequest)
            ...
            .catch(function (err) {
                    ...
                    termageddonPolicy.innerHTML = "There was an error loading this policy, please <a href='https://embed.termageddon.com/api/policy/TWtkWVptUlJNMnhyU20xUlMwRTlQUT09?origin="+window.location.href+"'>click here</a> to view it.";
            });
    }

    xhr.open("GET", "https://embed.termageddon.com/api/render/TWtkWVptUlJNMnhyU20xUlMwRTlQUT09?origin="+window.location.href);
    xhr.send();
}, false);
